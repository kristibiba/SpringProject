...
VALUES ('New Course', '1000', NOW(), 'admin');
...
INSERT INTO person (name, email, mobile_number, pwd, role_id, created_at, created_by)
VALUES ('TestRegisteredStudent1', 'TestRegisteredStudent1@gmail.com', '9876543210', '12345678',2,Now(),'DBA');

INSERT INTO person_courses (person_id, course_id)
VALUES ((SELECT person_id FROM person WHERE email = 'TestRegisteredStudent1@gmail.com'), 6);

INSERT INTO person_courses (person_id, course_id)
VALUES ((SELECT person_id FROM person WHERE email = 'TestRegisteredStudent1@gmail.com'), 7);
